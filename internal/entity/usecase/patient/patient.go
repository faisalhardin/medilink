...
type PatientUC interface {
	RegisterNewPatient(ctx context.Context, req model.RegisterNewPatientRequest, idempotencyKey string) (newPatientResponse model.GetPatientResponse, err error)
