...
type PatientHandler interface {
	...
	ListPatientVisitsDetailed(w http.ResponseWriter, r *http.Request)
	ArchivePatientVisit(w http.ResponseWriter, r *http.Request)
	...
	UpdateVisitProduct(w http.ResponseWriter, r *http.Request)
	ListVisitProducts(w http.ResponseWriter, r *http.Request)
}
